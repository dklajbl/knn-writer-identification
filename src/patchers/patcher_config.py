...
class PatcherConfig:
    ...
    Attributes:
        ...
        patch_height (default = 32): height of each patch (only used for random or sift patching)
        patch_width (default = 32): width of each patch (only used for random or sift patching)
    """
